...
class Scene_Battle < Scene_Base
  ...
  def start
    super
    # 배틀 시작시 상세보기 금지 스위치 온, 실험 수정 추가
    $game_switches[136] = true if $game_switches[136] == false
    $game_switches[137] = true if $game_switches[137] == false
  ...
  #--------------------------------------------------------------------------
  # * Start Party Command Selection # 수정
  #--------------------------------------------------------------------------
