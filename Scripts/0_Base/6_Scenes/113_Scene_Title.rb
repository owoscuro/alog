...
class Scene_Title < Scene_Base
  ...
  def dispose_background
    ...
    @sprite1.dispose
    @sprite2.bitmap.dispose if @sprite2.bitmap
    @sprite2.dispose
  end
  #--------------------------------------------------------------------------
  # * Free Foreground
  ...
  def dispose_foreground
    @foreground_sprite.bitmap.dispose if @foreground_sprite.bitmap
  ...
  def center_sprite(sprite)
    ...
    sprite.zoom_x = he_ro_zoom_x
    sprite.zoom_y = he_ro_zoom_y
  end
  #--------------------------------------------------------------------------
