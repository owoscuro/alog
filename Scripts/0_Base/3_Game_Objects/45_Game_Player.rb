...
class Game_Player < Game_Character
  ...
  # * 트리거 맵 이벤트
  # triggers : 트리거 배열
  # normal : 우선순위가 [문자와 동일]로 설정되어 있습니까?
  #--------------------------------------------------------------------------
