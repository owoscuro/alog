...
class Window_ShopStatus < Window_Base
  ...
  def refresh
    contents.clear
    draw_currency_value($game_party.gold,"",4,0,contents.width-10, 1)
    draw_possession(4, line_height)
    # Alog https://arca.live/b/alog
    #draw_possession(4, 0)
    draw_equip_info(4, line_height * 3) if @item.is_a?(RPG::EquipItem)
  end
  #--------------------------------------------------------------------------
  # * Get Party Gold
  #--------------------------------------------------------------------------
